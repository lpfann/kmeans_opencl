...
public class main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        CLBuffer<Integer> proto_Assignment = context.createIntBuffer(Usage.Output, IntBuffer.wrap(nearestPrototypeforVector), true);
...
//        CLKernel addFloatsKernel = program.createKernel("find_nearest_prototype");
        ...
        for (int t = 0; t < MAX_ITERATIONS; t++) {
            ...
            float[] newprototypes = new float[DIM * K];
            for (int i = 0; i < N; i++) {
                for (int d = 0; d < DIM; d++) {
            ...
            prototypeBuffer = context.createFloatBuffer(Usage.Input, FloatBuffer.wrap(prototypes), true);
            proto_Assignment = context.createIntBuffer(Usage.Output, IntBuffer.wrap(nearestPrototypeforVector), true);
